...
\fancyfoot[L]{%
	\small\color{gray}
	\lr{Chapter 4: VLAN Configuration}%
}
...
\begin{document}
	...
	\section{معرفی سوییچ DT7429}
	این بخش برای تکمیل مشخصات کلی، قابلیت‌های اصلی و محدودیت‌های
	سخت‌افزاری سوییچ DT7429 در نظر گرفته شده است.

	\section{قابلیت‌های Layer 2}
	این بخش باید قابلیت‌های اصلی Layer 2، از جمله VLAN، STP،
	Link Aggregation و قابلیت‌های پایش را معرفی کند.

	\section{پیکربندی پیش‌فرض}
	محتوای این بخش در نسخه فعلی هنوز تهیه نشده است.
	...
	% ============================================================================
	\section{\lr{Configuring Switch Port Modes (Access and Trunk)}}
	...
	\subsection{\lr{Configuration Example}}
	...
	% ============================================================================
	\section{\lr{Configuring Voice VLAN}}
	...
	مقدار سرعت فن در بازه \lr{0} تا \lr{255} تنظیم می‌شود:

	\begin{itemize}
		\item \lr{0}: حداقل سرعت یا خاموش بودن فن
		\item \lr{255}: حداکثر سرعت فن
	\end{itemize}

	\section{تنظیم سرعت فن}

	برای تنظیم سرعت فن، در حالت پیکربندی سراسری از دستور زیر استفاده کنید:
	...
	\begin{cautionbox}{هشدار}
		...
		برای حفظ پایداری و طول عمر تجهیزات، سرعت فن را متناسب با دمای محیط
		تنظیم کنید.
	\end{cautionbox}
